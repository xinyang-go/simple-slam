...
typedef enum
{
	...
	/// \~english All history_frames in the cache are discarded, and if the camera is now being exposed or transmitted it will be immediately interrupted, waiting to receive the next frame
...
typedef enum
{
	CAMERA_ST_CLEAR_BUFFER_BEFORE	= 0x1,	///< \~chinese ������֮ǰ���������ѻ����֡ \~english Empty camera-cached history_frames before soft triggering
